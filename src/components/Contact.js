          ...
          <div className="flex flex-col gap-5 lg:gap-9 lg:w/full">
            ...
            <p className="text-sm md:text-xl flex items-center md:items-start">
              ...
              <a
                ...
                className="ml-12 md:ml-12 text-[#00040f] dark:text-slate-300 break-all"
              >
                {Data.email}
              </a>
            </p>
            ...
            {Data.phone && (
              <p className="text-sm md:text-xl flex items-center md:items-start gap-3">
                ...
                <a
                  href={`tel:${Data.phone}`}
                  className="ml-12 md:ml-12 text-[#00040f] dark:text-slate-300"
                >
                  {Data.phone}
                </a>
              </p>
            ...
            <div className="mt-4 lg:mt-2 flex gap-2 lg:gap-4 justify-start text-left">
              {Data.github && (
                <a target="_blank" rel="noreferrer" href={Data.github} aria-label="GitHub">
                  <IoLogoGithub
              ...
              {Data.linkedin && (
                <a target="_blank" rel="noreferrer" href={Data.linkedin} aria-label="LinkedIn">
                  <BiLogoLinkedin
                    className="bg-[#8b98a5] p-3 rounded-full hover:bg-pink-500 hover:scale-110 transition-all duration-300 text-gray-800 cursor-pointer"
                    size={48}
                  />
              ...
              {Data.twitter && (
                <a target="_blank" rel="noreferrer" href={Data.twitter} aria-label="Twitter (X)">
                  <FaXTwitter
                    className="bg-[#8b98a5] p-3 rounded-full hover:bg-pink-500 hover:scale-110 transition-all duration-300 text-gray-800 cursor-pointer"
                    size={48}
                  />
