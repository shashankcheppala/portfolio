  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center mt-10 my-2 lg:py-6">
        <span className="text-[#00040f] dark:text-slate-300 text-center font-extrabold mb-10 max-sm:text-2xl p-2 px-8 text-5xl">
          Education
        </span>
      </div>

      <div
        className="flex flex-col items-center mt-16 md:flex-row md:justify-center space-y-10 md:space-y-0 md:space-x-10"
        data-aos="fade-up"
      >
        {/* Left animation */}
            ...
            >
              <div className="flex flex-col items-center text-center px-4 py-4">
                ...
                <img
                  ...
                  className="w-40 h-40 md:w-56 md:h-56 object-contain rounded-xl shadow-lg mb-4"
                />

                <p className="text-[#16f2b3] text-sm md:text-base mb-2">
                  {education.duration}
                </p>
                <p className="text-lg md:text-2xl font-semibold uppercase mb-1">
                  {education.title}
                </p>
